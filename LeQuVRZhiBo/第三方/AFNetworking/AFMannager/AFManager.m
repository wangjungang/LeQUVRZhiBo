...
//+ (BOOL)isLogoIn
//{
//    return [[NSFileManager defaultManager]fileExistsAtPath:TICKET_PATH];
//}
...
+(void)getReqURL2:(NSString*)str block:(void(^)(id infor))callBack errorblock:(void(^)(NSError *  error))errorBack
{
    str=[str stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
...
+(void)upLoadpath:(NSString*)path reqBody:(NSDictionary *)reqBodyDic file:(NSData*)data fileName:(NSString*)name fileType:(NSString*)type block:(void(^)(id infor))callBack errorBlock:(void(^)(NSError *  error))errorBlock;
{
    ...
    [sessinManager POST:path parameters:reqBodyDic constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData)
    {
        ...
        [formData appendPartWithFileData:data name:name fileName:@"file.png" mimeType:type];
        /******** 2.通过路径上传沙盒或系统相册里的图片 *****/
...
+(void)upLoadpath2:(NSString*)path reqBody:(NSDictionary *)reqBodyDic file:(NSData*)data fileName:(NSString*)name fileType:(NSString*)type block:(void(^)(id infor))callBack errorBlock:(void(^)(NSError *  error))errorBlock;
{
    AFHTTPSessionManager* sessinManager=[[AFHTTPSessionManager alloc] initWithBaseURL:[NSURL URLWithString:path]];
    sessinManager.responseSerializer=[AFJSONResponseSerializer serializer];
    sessinManager.responseSerializer.acceptableContentTypes=[NSSet setWithObjects:@"text/html", nil];
...
+(void)upLoadpath3:(NSString*)path reqBody:(NSDictionary *)reqBodyDic file:(NSData*)data fileName:(NSString*)name fileType:(NSString*)type block:(void(^)(id infor))callBack errorBlock:(void(^)(NSError *  error))errorBlock;
{
    AFHTTPSessionManager* sessinManager=[[AFHTTPSessionManager alloc] initWithBaseURL:[NSURL URLWithString:path]];
    sessinManager.responseSerializer=[AFJSONResponseSerializer serializer];
    sessinManager.responseSerializer.acceptableContentTypes=[NSSet setWithObjects:@"text/html", nil];
