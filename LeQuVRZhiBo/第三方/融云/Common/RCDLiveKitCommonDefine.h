...
#define RONGCLOUD_IM_APPKEY @"e5t4ouvper0qa"
#define RONGCLOUD_IM_APPSECRET @"X3r1WH5Iwc"
...
#define RCDLive_IMAGE_BY_NAMED(value) [UIImage imageNamed:(value)]
#else
...
/*!
 输入工具栏的输入模式
 */
typedef NS_ENUM(NSInteger,KBottomBarStatuss)
{
    /*!
     初始状态
     */
    KBottomBarDefaultStatuss = 0,
    /*!
     文本输入状态
     */

    KBottomBarKeyboardStatusss,
    /*!
     表情输入模式
     */
    KBottomBarEmojiStatuss
