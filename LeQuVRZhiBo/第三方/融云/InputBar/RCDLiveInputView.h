...
@protocol RCDLiveInputBarDelegate2;
...
@property(weak, nonatomic) id<RCDLiveInputBarDelegate2> delegate2;
/*!
 客服机器人转人工切换的按钮
 */
...
/*!
 文本输入框
 */
@property(strong, nonatomic)  myTextView *inputTextView;
...
@end
@protocol RCDLiveInputBarDelegate2 <NSObject>

@optional

- (void)diddanmu:(NSString *)num;
@end
