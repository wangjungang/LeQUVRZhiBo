...
@property (strong, nonatomic) WKScaleButton *longPressButton;
//indicator
...
- (void)setupUI
{
    _longPressButton=[[WKScaleButton alloc]initWithFrame:CGRectMake((DEVICE_WIDTH-150)/2, 300, 150, 150)];
    [self.view addSubview:_longPressButton];
    _preview =[[UIView alloc]initWithFrame:CGRectMake(0, 0, DEVICE_WIDTH, 300)];
    [self.view addSubview:_preview];
    _statusLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, 260,DEVICE_WIDTH , 40)];
    ...
    [_longPressButton setStateChangeBlock:^(WKState state){
        ...
        switch (state) {
            ...
            case WKStateOut: {
                ...
                [strongSelf showStatusLabelWithBackgroundColor:[UIColor redColor] textColor:[UIColor redColor] state:NO];
                break;
            }
            case WKStateCancle: {
