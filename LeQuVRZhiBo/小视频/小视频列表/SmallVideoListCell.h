...
@interface SmallVideoListCell : UITableViewCell
@property (nonatomic,strong)UIImageView *headerImage,*videoImage;
@property (nonatomic,strong)UILabel *nickLb,*peopleCountLb,*addTimeLb,*contentLb;
