...
@interface CommunityAnswerCell : UITableViewCell
@property (nonatomic,strong)UIImageView*heardImage;
@property (nonatomic,strong)UILabel*nickNameLb,*timeLb,*contentLb;
@property (nonatomic,strong)UIButton*deleteBtn,*answerBtn;
